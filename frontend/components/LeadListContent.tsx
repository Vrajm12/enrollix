...
export function LeadListContent() {
  ...
  useEffect(() => {
    void loadLeads();
  }, [stateFilter, cityFilter, localityFilter, pincodeFilter, courseFilter, sourceFilter, activeTab, searchTerm, page, pageSize]);
  ...
  const applyFilters = () => {
    ...
    setSourceFilter(draftSourceFilter.trim());
    setPage(1);
      ...
      <div className="flex flex-1 overflow-hidden md:ml-60">
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="px-4 md:px-6 py-4 bg-white border-b border-slate-200">
            ...
            />
            {(stateFilter || cityFilter || localityFilter || pincodeFilter || courseFilter || sourceFilter) && (
              <div className="mt-3 text-xs text-slate-600">
                ...
                {sourceFilter && <span className="ml-2 rounded bg-blue-100 px-2 py-1 text-blue-700">Source: {sourceFilter}</span>}
              </div>
            )}
          </div>
          ...
          {showFilterPopup && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
              <div className="w-full max-w-md rounded-xl bg-white p-5 shadow-2xl">
                ...
                <p className="mt-1 text-sm text-slate-600">Filter leads by State, District, City/Town/Village, Pincode, Course, and Source.</p>
